...
tokeniseTests =
  [ tokenise "1 + 2" @?= Right [Val (Int 1), Operator Plus, Val (Int 2)],
    ...
    tokenise "4**2" @?= Right [Val (Int 4), Operator PowOp, Val (Int 2)],
    ...
    tokenise "c||d" @?= Right [Ident "c", Operator PipeOp, Operator PipeOp, Ident "d"],
    ...
    tokenise "x==y" @?= Right [Ident "x", Operator EqOp, Ident "y"],
    tokenise "a!=b" @?= Right [Ident "a", Operator NotEqOp, Ident "b"],
